...
<body>
      ...
      <div class="bg-medium border-right" id="sidebar-wrapper" >
        <div class="sidebar-heading">DASHBOARD </div>
          <div class="list-group list-group-flush">
              <a href="http://ranegroup.com/rane-trw-steering-systems-private-limited/" class="list-group-item list-group-item-action bg-medium">HOME</a>
  ...
  <!-----------------------customer profile table------------------------------>           
              <tr><td><label for="cname" style="padding-right: 10px;"><b>Company name:</b></label></td><td><p placeholder="Enter Company name" name="  " id="name"  style="text-align: center; font-size: 20px;"><?php echo($cname);?></p></td></tr>
              ...
              <tr><td><label for= "pno"><b>Mobile number :</b></label></td><td><p id="pno"  style="font-size: 20px;" name="pno"  ><?php echo($pno);?></p></td></tr>                    
            </table><br></center>
            </div>
  <!-----------------------track order button------------------------------>           
